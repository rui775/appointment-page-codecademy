...
function App() {
  ...
  */
  const addContact = (name, phone, email) => {
    setContacts((prevContact) => [...prevContact, { name: name, phone: phone, email: email }]);
  };

  const addAppointment = (name, contact, date, time) => {
    setAppointments((prevAppointment) => [...prevAppointment, { name: name, contact: contact, date: date, time: time }]);;
  };
